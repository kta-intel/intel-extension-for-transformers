...
autoapi_options = ['members',
                   'show-module-summary' ]
autoapi_ignore = ['*/intel_extension_for_transformers/transformers/runtime/third_party/*']
...
exclude_patterns = ['_build_doxygen', '*/intel_extension_for_transformers/transformers/runtime/third_party/*']
